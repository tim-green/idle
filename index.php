...
<html lang="en" >
<head>
  <title>Idle - Work In Progress</title>
  <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="bg_left wow fadeInRight" data-wow-delay=".3s">
                            <img src="assets/images/device1_white.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="idle_title_span app_title_span text-center">
                            <span>No setup costs, just an awesome way to organise your business.</span>
                        </div>
