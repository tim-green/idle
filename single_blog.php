...
<!-- Start Preloader -->
        ...
        <!-- Start single_blog_main section -->
        <section class="single_blog_main section_padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="single_blog_main_content">
                            ...
                            <div class="content_text_area">
                                <h2>With our vastly improved notifications system, users have more control on your mind.</h2>
                                <p class="p_35">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco  laboris nisi ut aliquip ex ea commodo amet set for your cool happiness for lyour loyal city.</p>
                                ...
                                <img src="assets/img/sb_1.jpg" class="img-fluid" alt="">
                                ...
                                <div class="inner_content">
                                    <div class="content_img">
                                        <img src="assets/img/sb_2.jpg" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="content_share_area mb_50">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="tags_area">
                                            <h4>Releted Tags</h4>
                            ...
                            <div class="prev_next_area mb_40">
                                <div class="row">
                            ...
                            <div class="releted_post">
                                <div class="releted_post_title mb_35">
                                    <h4>Releted Post</h4>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                        ...
                        <div class="comment_area mb_50">
                            <div class="comment_title mb_35">
                                <h4>Comments</h4>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="widget_sidebar text-center">
                            <div class="search_widget mb_60">
                            ...
                            <div class="instagram_widget mb_60">
                                <div class="sidebar_widget_title">
                                    <h3>Instagram</h3>
                                </div>
                                <div class="row">
                            ...
                            <div class="categroies_widget mb_60">
                                <div class="sidebar_widget_title">
                                    <h3>Categories</h3>
                                </div>
                            ...
                            <div class="feeds_widget mb_60">
                                ...
                                <div class="feeds_single">
                                    ...
                                    <div class="feeds_info">
                                        ...
                                        <p><i class="far fa-clock"></i>6 Hours ago</p>
                                    </div>
                                </div>
                                <div class="feeds_single">
                                    <div class="feeds_img">
                    ...
                    <div class="col-lg-4">
                        <div class="widget_area">
                            ...
                            <div class="widget-img">
                                <img src="assets/img/f_1.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="widget-link">
                                <ul>
